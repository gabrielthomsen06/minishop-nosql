...
from core.ports import SessionStore, EventStore, MetricsStore, Product
...
class MiniShopApp:
    def __init__(self, session_store: SessionStore, event_store: EventStore, metrics_store: MetricsStore):
    ...
    def login(self):
        ...
        self.event_svc.emit("user_login", sess.user_id, sess.session_id, {"created_at": sess.created_at.isoformat()})
