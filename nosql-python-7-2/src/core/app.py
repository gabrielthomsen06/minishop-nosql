...
class MiniShopApp:
        ...
        while True:
            ...
            if choice == "1":
                ...
                if self.current_session_id:
                   self.event_svc.cleanup_expired_for_session(self.current_session_id)
                   # - Instrutor --> Mantenha esta linha comentada
    ...
    def _print_banner(self):
        ...
        print(" Redis -> implementado | Mongo -> implementado | Cassandra -> implementado")
        print("===================================\n")
